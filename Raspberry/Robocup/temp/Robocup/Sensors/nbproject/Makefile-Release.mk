...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsensors.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsensors.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsensors.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsensors.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsensors.a

${OBJECTDIR}/AddDistanceCommand.o: AddDistanceCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AddDistanceCommand.o AddDistanceCommand.cpp

${OBJECTDIR}/CheckWithBreak.o: CheckWithBreak.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckWithBreak.o CheckWithBreak.cpp
...
${OBJECTDIR}/DirectComCommand.o: DirectComCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DirectComCommand.o DirectComCommand.cpp
...
${OBJECTDIR}/DistanceSensorCheck.o: DistanceSensorCheck.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DistanceSensorCheck.o DistanceSensorCheck.cpp

${OBJECTDIR}/LineCheck.o: LineCheck.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineCheck.o LineCheck.cpp

${OBJECTDIR}/LoggingSetting.o: LoggingSetting.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoggingSetting.o LoggingSetting.cpp

${OBJECTDIR}/MoveFixedDirCommand.o: MoveFixedDirCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MoveFixedDirCommand.o MoveFixedDirCommand.cpp

${OBJECTDIR}/PortCheck.o: PortCheck.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PortCheck.o PortCheck.cpp

${OBJECTDIR}/ResetMoveCommand.o: ResetMoveCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResetMoveCommand.o ResetMoveCommand.cpp

${OBJECTDIR}/SensorFactory.o: SensorFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SensorFactory.o SensorFactory.cpp
...
${OBJECTDIR}/SnapshotCommand.o: SnapshotCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SnapshotCommand.o SnapshotCommand.cpp

${OBJECTDIR}/SpeedCommand.o: SpeedCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SpeedCommand.o SpeedCommand.cpp

${OBJECTDIR}/StartDistanceCommand.o: StartDistanceCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StartDistanceCommand.o StartDistanceCommand.cpp

${OBJECTDIR}/SwitchCheck.o: SwitchCheck.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SwitchCheck.o SwitchCheck.cpp
