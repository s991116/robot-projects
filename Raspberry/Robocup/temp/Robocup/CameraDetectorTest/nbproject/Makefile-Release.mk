...
${OBJECTDIR}/LineDetectInfoTest.o: LineDetectInfoTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineDetectInfoTest.o LineDetectInfoTest.cpp

${OBJECTDIR}/LineDetectTest.o: LineDetectTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineDetectTest.o LineDetectTest.cpp
