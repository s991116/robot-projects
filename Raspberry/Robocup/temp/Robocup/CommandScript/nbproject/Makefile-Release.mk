...
${OBJECTDIR}/CommandScript.o: CommandScript.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommandScript.o CommandScript.cpp

${OBJECTDIR}/ConsolePrint.o: ConsolePrint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConsolePrint.o ConsolePrint.cpp

${OBJECTDIR}/ParseCommandLine.o: ParseCommandLine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseCommandLine.o ParseCommandLine.cpp
