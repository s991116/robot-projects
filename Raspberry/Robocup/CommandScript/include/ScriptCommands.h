...
struct ScriptCommands {
    ...
    static map<string, int> CreateCommands() {
        ...
        m["CMD_SET_SERVO_POSITION"] = CMD_SET_SERVO_POSITION;
        m["CMD_SET_SERVO_MAX_POSITION"] = CMD_SET_SERVO_MAX_POSITION;
        m["CMD_SET_SERVO_MIN_POSITION"] = CMD_SET_SERVO_MIN_POSITION;
        m["CMD_GET_SERVO_POSITION"] = CMD_GET_SERVO_POSITION;
		m["CMD_SET_LED_MODE"] = CMD_SET_LED_MODE;
