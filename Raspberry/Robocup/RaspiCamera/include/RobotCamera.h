...
enum class CameraMode {FOLLOW_LINE=0, FIND_BOOK=1, FIND_BALL=2, FIND_BOOK_FAST=3, NAVIGATE_TO_BOOK=4, NAVIGATE_TO_BOOK_FAST=5, FOLLOW_LEFT_TO_LINE=6, FOLLOW_WITH_DOOR_OPEN=7, FOLLOW_LINE_FAST=8};
