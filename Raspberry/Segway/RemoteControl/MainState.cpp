...
MainState::MainState(State* motorState, State* gyroState, State* servoState, State* cameraState, State* comState, State* navigateState, State* scriptRunner) {
    ...
    _ScriptRunner->ReturnState = this;
}
