...
${OBJECTDIR}/ArduinoDataHandler.o: ArduinoDataHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArduinoDataHandler.o ArduinoDataHandler.cpp

${OBJECTDIR}/ArduinoSerial.o: ArduinoSerial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArduinoSerial.o ArduinoSerial.cpp
...
${OBJECTDIR}/DataPackets.o: DataPackets.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataPackets.o DataPackets.cpp

${OBJECTDIR}/MessageDataProtocol.o: MessageDataProtocol.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageDataProtocol.o MessageDataProtocol.cpp
...
${TESTDIR}/Mocks/HandlerMock.o: Mocks/HandlerMock.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/Mocks/HandlerMock.o Mocks/HandlerMock.cpp


${TESTDIR}/Mocks/SerialBufferMock.o: Mocks/SerialBufferMock.cpp 
	${MKDIR} -p ${TESTDIR}/Mocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/Mocks/SerialBufferMock.o Mocks/SerialBufferMock.cpp


${TESTDIR}/Mocks/SerialComMock.o: Mocks/SerialComMock.cpp 
	${MKDIR} -p ${TESTDIR}/Mocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/Mocks/SerialComMock.o Mocks/SerialComMock.cpp


${TESTDIR}/Mocks/SerialConnectorMock.o: Mocks/SerialConnectorMock.cpp 
	${MKDIR} -p ${TESTDIR}/Mocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/Mocks/SerialConnectorMock.o Mocks/SerialConnectorMock.cpp


${TESTDIR}/_ext/275589469/gtest-all.o: ../../gtest-1.7.0/src/gtest-all.cc 
	${MKDIR} -p ${TESTDIR}/_ext/275589469
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/275589469/gtest-all.o ../../gtest-1.7.0/src/gtest-all.cc
...
${OBJECTDIR}/ArduinoDataHandler_nomain.o: ${OBJECTDIR}/ArduinoDataHandler.o ArduinoDataHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArduinoDataHandler_nomain.o ArduinoDataHandler.cpp;\
	else  \
...
${OBJECTDIR}/ArduinoSerial_nomain.o: ${OBJECTDIR}/ArduinoSerial.o ArduinoSerial.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArduinoSerial_nomain.o ArduinoSerial.cpp;\
	else  \
...
${OBJECTDIR}/DataHandler_nomain.o: ${OBJECTDIR}/DataHandler.o DataHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataHandler_nomain.o DataHandler.cpp;\
	else  \
...
${OBJECTDIR}/DataPackets_nomain.o: ${OBJECTDIR}/DataPackets.o DataPackets.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataPackets_nomain.o DataPackets.cpp;\
	else  \
...
${OBJECTDIR}/MessageDataProtocol_nomain.o: ${OBJECTDIR}/MessageDataProtocol.o MessageDataProtocol.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageDataProtocol_nomain.o MessageDataProtocol.cpp;\
	else  \
