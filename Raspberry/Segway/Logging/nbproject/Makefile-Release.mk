...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblogging.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblogging.a: ${OBJECTFILES}
...
${OBJECTDIR}/ConsolePrint.o: ConsolePrint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConsolePrint.o ConsolePrint.cpp

${OBJECTDIR}/EmptyLog.o: EmptyLog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EmptyLog.o EmptyLog.cpp

${OBJECTDIR}/FileLogger.o: FileLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileLogger.o FileLogger.cpp

${OBJECTDIR}/ProxyLog.o: ProxyLog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProxyLog.o ProxyLog.cpp
